...
//CL SYS ID
PARAM_DEFINE_FLOAT(CLSYSID_tExcite, 0.0f);
PARAM_DEFINE_FLOAT(CLSYSID_step, 0.0f);
PARAM_DEFINE_FLOAT(CLSYSID_nom_p, 0.0f);
PARAM_DEFINE_FLOAT(CLSYSID_nom_r, 0.0f);
PARAM_DEFINE_INT32(CLSYSID_man, 0);
PARAM_DEFINE_INT32(CLSYSID_ctrlin, 0);
PARAM_DEFINE_INT32(CLSYSID_rep, 3);
PARAM_DEFINE_INT32(CLSYSID_f_st, 0);
PARAM_DEFINE_INT32(CLSYSID_f_end, 10);
//PARAM_DEFINE_INT32(CLSYSID_Fs, 1000);
PARAM_DEFINE_INT32(CLSYSID_settle, 0);
